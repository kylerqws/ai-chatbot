...
type FileService interface {
	// NewUploadFileRequest returns a new upload file request.
	NewUploadFileRequest() *ctrsvc.UploadFileRequest

	// NewUploadFileResponse returns a new upload file response.
	...
	// NewRetrieveFileRequest returns a new retrieve file request.
	NewRetrieveFileRequest() *ctrsvc.RetrieveFileRequest

	// NewRetrieveFileResponse returns a new retrieve file response.
	...
	// NewRetrieveFileContentRequest returns a new retrieve file content request.
	NewRetrieveFileContentRequest() *ctrsvc.RetrieveFileContentRequest

	// NewRetrieveFileContentResponse returns a new retrieve file content response.
	...
	// NewListFilesRequest returns a new list files request.
	NewListFilesRequest() *ctrsvc.ListFilesRequest

	// NewListFilesResponse returns a new list files response.
	...
	// NewDeleteFileRequest returns a new delete file request.
	NewDeleteFileRequest() *ctrsvc.DeleteFileRequest

	// NewDeleteFileResponse returns a new delete file response.
