...
func (*service) NewUploadFileRequest() *ctrsvc.UploadFileRequest {
	return &ctrsvc.UploadFileRequest{}
}

// NewUploadFileResponse creates a new upload file response.
func (*service) NewUploadFileResponse() *ctrsvc.UploadFileResponse {
...
func (*service) NewRetrieveFileRequest() *ctrsvc.RetrieveFileRequest {
	return &ctrsvc.RetrieveFileRequest{}
}

// NewRetrieveFileResponse creates a new retrieve file response.
func (*service) NewRetrieveFileResponse() *ctrsvc.RetrieveFileResponse {
...
func (*service) NewRetrieveFileContentRequest() *ctrsvc.RetrieveFileContentRequest {
	return &ctrsvc.RetrieveFileContentRequest{}
}

// NewRetrieveFileContentResponse creates a new retrieve file content response.
func (*service) NewRetrieveFileContentResponse() *ctrsvc.RetrieveFileContentResponse {
...
func (*service) NewListFilesRequest() *ctrsvc.ListFilesRequest {
	return &ctrsvc.ListFilesRequest{}
}

// NewListFilesResponse creates a new list files response.
func (*service) NewListFilesResponse() *ctrsvc.ListFilesResponse {
...
func (*service) NewDeleteFileRequest() *ctrsvc.DeleteFileRequest {
	return &ctrsvc.DeleteFileRequest{}
}

// NewDeleteFileResponse creates a new delete file response.
func (*service) NewDeleteFileResponse() *ctrsvc.DeleteFileResponse {
